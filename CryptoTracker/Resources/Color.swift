...
struct ColorTheme {
    ...
    let ctGreen = Color("CTGreenColor")
    let ctRed = Color("CTRedColor")
...
struct ColorTheme2 {
    ...
    let ctGreen = Color(#colorLiteral(red: 0, green: 0.5603182912, blue: 0, alpha: 1))
    let ctRed = Color(#colorLiteral(red: 0.5807225108, green: 0.066734083, blue: 0, alpha: 1))
